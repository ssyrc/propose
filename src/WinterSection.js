...
function WinterSection() {
  ...
  return (
      <Section>
        ...
        {/* 뒤쪽 어두운 눈 Wavify */}
        <div style={{ position: "absolute", bottom: 0, left: 0, width: "100%", height: "80px", zIndex: 10 }}>
            <Wavify
              fill="#bfc7d6"
              paused={true}
              options={{
        ...
        {/* 앞쪽 밝은 눈 Wavify */}
        <div style={{ position: "absolute", bottom: 0, left: 0, width: "100%", height: "120px", zIndex: 11 }}>
            <Wavify
              fill="#fff"
              paused={true}
              options={{
